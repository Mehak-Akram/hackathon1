...
class Settings(BaseSettings):
    ...
    gemini_api_key: Optional[str] = Field(default=None, description="Gemini API key for agent functionality", alias="GEMINI_API_KEY")
    ...
    session_timeout_minutes: int = Field(default=30, description="Minutes of inactivity before session expires", alias="SESSION_TIMEOUT_MINUTES")
    ...
    # Agent Configuration
    agent_model: str = Field(default="gpt-4-turbo-preview", description="Default OpenAI model to use")
